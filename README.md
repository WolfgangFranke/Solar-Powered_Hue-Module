...
<br/>
The LTC3588, with the components I tested and use in this circuit, has a high energy transmission efficiency of ≈90% for small currents like a Philips Hue module consumes. But soldering the IC is a bit difficult, because the bottom of the IC needs to be connected to GND. I used a tiny breakout board and drilled a whole to connect GND.<br/>
<br/>
